    ...
    <div class="w-full max-w-md">
        ...
        <div class="card-flat p-10">
            ...
            <p class="text-sm text-dark-500 text-center mb-8">
                Don't have an account? <a href="{{ route('register') }}" class="font-medium text-primary-500 hover:text-primary-600">Create one</a>
            </p>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-sm font-medium text-primary-500 hover:text-primary-600">
                            Forgot password?
                        </a>
                    @endif
                </div>
