    ...
    <div class="min-h-screen flex" x-data="{ sidebarOpen: true }">
        ...
        <aside :class="sidebarOpen ? 'w-72' : 'w-24'" class="bg-dark-800 text-white transition-all duration-300 flex flex-col fixed h-full z-50 shadow-soft-xl">
            ...
            <nav class="mt-6 px-3 flex-1 space-y-1">
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="sidebar-item <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    <span x-show="sidebarOpen" class="font-medium">Categories</span>
                </a>
                <a href="<?php echo e(route('admin.products.index')); ?>" class="sidebar-item <?php echo e(request()->routeIs('admin.products.*') ? 'active' : ''); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                    <span x-show="sidebarOpen" class="font-medium">Products</span>
                </a>
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="sidebar-item <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.coupons.index')); ?>" class="sidebar-item <?php echo e(request()->routeIs('admin.coupons.*') ? 'active' : ''); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                    <span x-show="sidebarOpen" class="font-medium">Coupons</span>
                </a>
                <a href="<?php echo e(route('admin.returns.index')); ?>" class="sidebar-item <?php echo e(request()->routeIs('admin.returns.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.reviews.index')); ?>" class="sidebar-item <?php echo e(request()->routeIs('admin.reviews.*') ? 'active' : ''); ?>">
            ...
            <div class="p-4 border-t border-dark-700">
                <div class="flex items-center gap-3 mb-3">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(auth()->user()->name); ?>&background=22c55e&color=fff&size=64" class="w-12 h-12 rounded-xl border-2 border-primary-500" alt="">
        ...
        <main :class="sidebarOpen ? 'ml-72' : 'ml-24'" class="flex-1 transition-all duration-300 min-h-screen p-8">
            ...
            <header class="mb-8 flex justify-between items-center">
                <div>
                    <h2 class="text-3xl font-bold text-dark-800 dark:text-white"><?php echo $__env->yieldContent('title'); ?></h2>
...
<?php /**PATH C:\Users\umesh\fightwisdoml2\resources\views/layouts/admin.blade.php ENDPATH**/ ?>