    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-2xl">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="<?php echo e(route('shop')); ?>" class="btn-primary !py-4 !px-8 text-lg rounded-full group">
                    <span class="flex items-center gap-2">
                        Shop Now
                        <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                    </span>
                </a>
                <a href="<?php echo e(route('shop')); ?>?featured=1" class="btn-secondary !py-4 !px-8 text-lg rounded-full">
                    <span class="flex items-center gap-2">
                        Featured
...
<section class="py-24 bg-white dark:bg-dark-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="<?php echo e(route('shop')); ?>" class="link-arrow hidden sm:flex">
                View All Categories
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('shop', ['category' => $category->slug])); ?>" class="group text-center">
                    <div class="relative aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-dark-100 to-dark-200 dark:from-dark-700 dark:to-dark-800 mb-4 shadow-sm group-hover:shadow-xl group-hover:shadow-primary-500/10 transition-all duration-500">
                        ...
                        <?php else: ?>
                            <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary-500/20 to-accent-500/20">
                                <span class="text-4xl font-bold bg-gradient-to-r from-primary-500 to-accent-500 bg-clip-text text-transparent"><?php echo e(substr($category->name, 0, 1)); ?></span>
                            </div>
                        <?php endif; ?>
                    ...
                    <h3 class="font-bold text-dark-800 dark:text-white group-hover:text-primary-500 transition-colors duration-300"><?php echo e($category->name); ?></h3>
                </a>
