...
<div class="min-h-screen flex items-center justify-center py-12 px-4 bg-dark-50 dark:bg-dark-950">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <a href="<?php echo e(route('home')); ?>" class="text-3xl font-black inline-flex">
        ...
        <div class="card-flat p-10">
            <h2 class="text-3xl font-black text-dark-800 dark:text-white text-center mb-2">Welcome Back</h2>
            <p class="text-sm text-dark-500 text-center mb-8">
                Don't have an account? <a href="<?php echo e(route('register')); ?>" class="font-medium text-primary-500 hover:text-primary-600">Create one</a>
            </p>
...
<?php endif; ?>
            ...
            <?php if(session('error')): ?>
                <div class="mb-4 p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-xl text-sm">
...
<?php endif; ?>
                ...
                <div class="flex items-center justify-between">
                    <label for="remember_me" class="flex items-center cursor-pointer">
                        <input id="remember_me" type="checkbox" name="remember" class="rounded text-primary-500 focus:ring-primary-500">
                        <span class="ml-2 text-sm text-dark-500">Remember me</span>
                    </label>

                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-medium text-primary-500 hover:text-primary-600">
                            Forgot password?
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="mt-8">
                ...
                <div class="mt-6 grid grid-cols-1 gap-3">
                    <a href="<?php echo e(route('auth.google')); ?>" class="w-full inline-flex justify-center items-center gap-2 bg-white dark:bg-dark-700 border border-dark-200 dark:border-dark-600 rounded-xl px-6 py-4 hover:bg-dark-50 dark:hover:bg-dark-600 transition-all">
...
<?php echo $__env->make('components.guest-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\umesh\fightwisdoml2\resources\views/auth/login.blade.php ENDPATH**/ ?>