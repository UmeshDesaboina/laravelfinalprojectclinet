    ...
    <div class="stat-card group">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-dark-800 dark:text-white mt-2"><?php echo e($totalOrders); ?></h3>
    ...
    <div class="stat-card group">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-dark-800 dark:text-white mt-2">₹<?php echo e(number_format($totalRevenue, 2)); ?></h3>
                <p class="text-xs text-green-600 mt-2 flex items-center gap-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>
                    +8.2% from last month
                </p>
    ...
    <div class="stat-card group">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-dark-800 dark:text-white mt-2"><?php echo e($totalUsers); ?></h3>
                <p class="text-xs text-green-600 mt-2 flex items-center gap-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>
                    +5.3% from last month
                </p>
    ...
    <div class="stat-card group">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-3xl font-bold text-dark-800 dark:text-white mt-2"><?php echo e($totalProductsSold); ?></h3>
                <p class="text-xs text-green-600 mt-2 flex items-center gap-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
    ...
    <div class="card-flat p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-sm font-semibold text-primary-500 hover:text-primary-600 transition-colors">View All</a>
        </div>
                ...
                <tbody class="divide-y divide-dark-100 dark:divide-dark-700">
                    <?php $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="table-row text-sm">
                            <td class="py-4 px-2 font-semibold text-dark-800 dark:text-white"><?php echo e($order->order_number); ?></td>
                            <td class="py-4 px-2">
                                <div class="flex items-center gap-3">
                                    <img src="https://ui-avatars.com/api/?name=<?php echo e($order->user->name); ?>&background=6366f1&color=fff&size=32" class="w-8 h-8 rounded-lg" alt="">
                                    <span class="text-dark-700 dark:text-dark-300"><?php echo e($order->user->name); ?></span>
                                </div>
                            </td>
                            <td class="py-4 px-2 font-semibold text-dark-800 dark:text-white">₹<?php echo e(number_format($order->total, 2)); ?></td>
                            <td class="py-4 px-2">
...
<!-- Alerts Section -->
<?php if($lowStockProducts->count() > 0 || $pendingReviews > 0 || $pendingReturns > 0): ?>
    ...
    <div class="card-flat p-6 border-l-4 border-orange-500">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-xs text-dark-500"><?php echo e($lowStockProducts->count()); ?> products need attention</p>
            </div>
        </div>
        <div class="space-y-2">
            <?php $__currentLoopData = $lowStockProducts->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between text-sm">
                <span class="text-dark-700 dark:text-dark-300 line-clamp-1"><?php echo e($product->name); ?></span>
                <span class="font-bold text-orange-500"><?php echo e($product->stock); ?> left</span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <a href="<?php echo e(route('admin.products.index')); ?>?stock=low" class="text-xs font-semibold text-primary-500 hover:text-primary-600 mt-3 inline-flex items-center gap-1">
    ...
    <div class="card-flat p-6 border-l-4 border-yellow-500">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-xs text-dark-500"><?php echo e($pendingReviews); ?> awaiting approval</p>
            </div>
        </div>
        <a href="<?php echo e(route('admin.reviews.pending')); ?>" class="btn-secondary !py-2 !px-4 !text-sm w-full justify-center">
            Moderate Reviews
        </a>
    </div>
    <?php endif; ?>
    ...
    <div class="card-flat p-6 border-l-4 border-red-500">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                ...
                <p class="text-xs text-dark-500"><?php echo e($pendingReturns); ?> pending approval</p>
            </div>
        </div>
        <a href="<?php echo e(route('admin.returns.index')); ?>?status=pending" class="btn-secondary !py-2 !px-4 !text-sm w-full justify-center">
            Review Returns
        </a>
    </div>
    <?php endif; ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="flex items-center gap-3 p-3 bg-dark-50 dark:bg-dark-700/50 rounded-xl">
            <?php if($item->product->images->count() > 0): ?>
                <img src="<?php echo e(asset('storage/' . $item->product->images->first()->image)); ?>" class="w-12 h-12 rounded-lg object-cover" alt="">
            <?php else: ?>
                <div class="w-12 h-12 rounded-lg bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center">
                    <span class="text-primary-500 font-bold text-xs"><?php echo e(substr($item->product->name, 0, 2)); ?></span>
                </div>
            <?php endif; ?>
            <div class="flex-1 min-w-0">
                <p class="text-sm font-bold text-dark-800 dark:text-white line-clamp-1"><?php echo e($item->product->name); ?></p>
                <p class="text-xs text-primary-500 font-bold"><?php echo e($item->total_sold); ?> sold</p>
            </div>
        </div>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    new Chart(ctx, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($salesData->pluck('date')); ?>,
            datasets: [{
                label: 'Sales (₹)',
                data: <?php echo json_encode($salesData->pluck('total')); ?>,
                borderColor: '#22c55e',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\umesh\fightwisdoml2\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>