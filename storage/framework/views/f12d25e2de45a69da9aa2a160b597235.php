    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if($orders->isEmpty()): ?>
            <div class="card-flat p-20 text-center">
                ...
                <a href="<?php echo e(route('shop')); ?>" class="btn-primary !py-4 !px-8 rounded-full inline-flex items-center gap-2">
                ...
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-flat p-8 flex flex-col md:flex-row justify-between items-center gap-8 group hover:border-primary-500 transition-all">
                        <div class="flex items-center gap-8">
                            ...
                            <div>
                                <p class="text-xs font-black uppercase tracking-widest text-dark-400 mb-1">Placed on <?php echo e($order->created_at->format('M d, Y')); ?></p>
                                <h3 class="text-xl font-black text-dark-800 dark:text-white">₹<?php echo e(number_format($order->total, 2)); ?></h3>
                        ...
                        <div class="flex items-center gap-4">
                            <a href="<?php echo e(route('orders.show', $order)); ?>" class="btn-secondary !py-3 !px-6">
                            ...
                            <?php if($order->status === 'delivered'): ?>
                                <a href="<?php echo e(route('orders.return.form', $order)); ?>" class="px-6 py-3 rounded-xl font-bold text-dark-500 hover:text-primary-500 transition-colors">
                                    Return
                                </a>
                            <?php endif; ?>
